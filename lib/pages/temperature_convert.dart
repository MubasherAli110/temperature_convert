...
class TemperatureConvert extends StatefulWidget {
  const TemperatureConvert({super.key});

  @override
  State<TemperatureConvert> createState() => _TemperatureConvertState();
}

class _TemperatureConvertState extends State<TemperatureConvert> {
